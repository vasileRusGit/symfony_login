...
class TodoController extends Controller {
    ...
    public function lsitAction() {
        $todos = $this->getDoctrine()->getRepository('LoginAppBundle:Todo')->findAll();
    ...
    public function createAction(Request $request) {
        ...
        $form = $this->createFormBuilder($todo)
                ...
                ->add('submit', SubmitType::class, array('attr' => array('class' => 'btn btn-primary', 'style' => 'margin-top:15px')))
                ->getForm();
    ...
    public function editAction($id, Request $request) {
        $todo = $this->getDoctrine()->getRepository('LoginAppBundle:Todo')->find($id);
        ...
        $form = $this->createFormBuilder($todo)
                ...
                ->add('priority', ChoiceType::class, array('choices' => array('Low' => 'Low', 'Medium' => 'Medium', 'High' => 'High'), 'attr' => array('class' => 'form-control', 'style' => 'margin-bottom:15px')))
                ->add('due_date', DateTimeType::class, array('attr' => array('style' => 'margin-bottom:15px')))
                ->add('Update', SubmitType::class, array('attr' => array('class' => 'btn btn-primary', 'style' => 'margin-top:15px')))
                ->getForm();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em = $this->getDoctrine()->getManager();
            $todo = $em->getRepository('LoginAppBundle:Todo')->find($id);
    ...
    public function deleteAction($id) {
        ...
        // messages
        $this->addFlash('delete', 'Todo Removed');
